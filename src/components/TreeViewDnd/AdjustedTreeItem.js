/**
 * Due to some issue with react-dnd we have to adjust the TreeItem component (mui-lab)
 */
...
const AdjustedTreeItem = React.forwardRef(function TreeItem(inProps, ref) {
...
AdjustedTreeItem.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
...
export default AdjustedTreeItem;
